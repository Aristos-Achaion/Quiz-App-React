...
export default function Summary({ userAnswers }) {
  ...
  const correctAnsweres = userAnswers.filter(
  ...
  const correctAnsweresShare = Math.round(
    (correctAnsweres.length / userAnswers.length) * 100
  );
  const wrongAnswersShare = 100 - skippedAnsweresShare - correctAnsweresShare;
